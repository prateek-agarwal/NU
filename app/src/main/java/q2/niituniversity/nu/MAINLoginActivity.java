...
public class MAINLoginActivity extends AppCompatActivity implements
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            // HANDLE EMAIL AND NAME FROM HERE
            GoogleSignInAccount acct = result.getSignInAccount();
            String userEmail = getString(R.string.signed_in_fmt, acct.getEmail());
            String userName = getString(R.string.signed_in_fmt, acct.getDisplayName());



            //TODO : CHECK IN WITH DATABASE
            isLoggedInUser.setLogin(true);
            Intent intent = new Intent(this, MAINContainer.class);
            startActivity(intent);
            finish();
        } else {
